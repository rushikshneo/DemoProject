						...
						<div class="col-sm-5">
							<div class="view-product">
							   @foreach($product_details as $pro_det)
							      @foreach($pro_det->images as $pro_image)
								<img src="{{URL::asset($pro_image->image_url)}}" style="margin-left: 50px; width: 90%;" alt="" />
								   <h3>ZOOM</h3>
								 @endforeach
							  </div>
<!-- 							<div id="similar-product" class="carousel slide" data-ride="carousel">
						...
						<div class="col-sm-7">
							<div class="product-information">
								<!--/product-information-->
								 <img class="newarrival" alt="" />

								<h2>{{$pro_det->name}}</h2>
								<p> Web ID:{{$pro_det->id}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="details" >
							   <div>
							   	 <p style="margin-left: 20px;"> {{$pro_det->short_description}} <span id="more_description">{{$pro_det->long_description}}1</span> <a id="show">Show More</a></p>
							   </div>
							</div>
								@endforeach
